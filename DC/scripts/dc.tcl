...
#Saving sdc
write_sdc ../outputs/me_on_chip_clk_with_driving.sdc
...
###YBR
write -format verilog -hier -out ../outputs/me_on_chip_clk_with_driving.v
write -format ddc -hier -out ../outputs/me_on_chip_clk_with_driving.ddc
